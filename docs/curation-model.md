...
6. `token-economics` — flat pricing intuitions → caching, model-tiering, refinement-first discipline. **Done** (2026-07-10; founded on three owner research docs in `research/` + parked open-questions claims; cited by A4, A2E, C2, C5). Remaining: entry 4 (`agent-orchestration`) — the last founding entry.